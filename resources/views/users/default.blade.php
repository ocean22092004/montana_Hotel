...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/themify-icons/1.0.0/themify-icons.min.css">
                    ...
                    <div class="row align-items-center no-gutters">
                                    ...
                                    <ul id="navigation">
                                        ...
                                        <li><a href="#">blog <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                            <ul class="submenu">
                                                ...
                                                <li><a href="{{ route('users.single_blog')}}">single-blog</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#">pages <i class="fa fa-angle-down" aria-hidden="true"></i></i></a>
                                            <ul class="submenu">
                                                <li><a href="{{ route('users.elements')}}">elements</a></li>
                                            </ul>
                                        </li>
                        ...
                        <div class="col-xl-5 col-lg-4 d-none d-lg-block">
                            <div class="book_room">
                                ...
                                <div class="book_btn d-none d-lg-block" style="margin-right: 50px ">
                                    ...
                                    @if (isset(Auth::user()->name))
                                        <div class="dropdown">
                                            ...
                                            <a class="dropdown-item" style="background-color:white; color:black" href="{{route('detailBooking')}}">My booked</a>
                                    ...
                                    @else
                                        <a class="btn btn-primakey" href="/login">Log in</a>
                                    @endif
                                </div>
                            </div>
                        </div>
